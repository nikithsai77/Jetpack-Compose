...
@Composable
fun SharedTransitionScope.ListScreen(onItemClick: (resId: Int, title: String) -> Unit, animatedVisibilityScope: AnimatedVisibilityScope) {
    ...
    LazyColumn(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.spacedBy(16.dp), contentPadding = PaddingValues(16.dp)) {
        itemsIndexed(drawables) { index, resId ->
            ...
            Row(modifier = Modifier
                ...
                Text(text = text, modifier = Modifier.weight(1f).align(Alignment.CenterVertically)
                    .sharedElement(
