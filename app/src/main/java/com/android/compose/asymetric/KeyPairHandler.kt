package com.android.compose.asymetric
...
private const val KEYSTORE_ALIAS = "apiKeys"
...
object KeyPairHandler {
    ...
    fun generateKey() {
        ...
        // RSA Will Generates 2 key's (Public & Private Key)
        // Public Key is used to do the Encryption & Private Key is used to do the Decryption.
